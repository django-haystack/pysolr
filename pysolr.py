...
# Strips the C0 control characters, keeping tab, newline and carriage return,
# which are valid whitespace.
...
def sanitize(data):
    ...
    valid whitespace.
    """
    return force_unicode(data).translate(SANITIZED_CHARS_TABLE)
