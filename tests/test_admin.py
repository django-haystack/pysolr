...
class SolrCoreAdminTestCase(unittest.TestCase):
    ...
    def test_create(self):
        self.assertTrue(
            '<int name="status">0</int>' in self.solr_admin.create("wheatley")
        )
    ...
    def test_rename(self):
        ...
        self.assertTrue(
            '<int name="status">0</int>' in self.solr_admin.rename("wheatley", "rick")
        )
    ...
    def test_swap(self):
        ...
        self.assertTrue(
            '<int name="status">0</int>' in self.solr_admin.swap("wheatley", "rick")
        )
